...
const parser = Parser.deserialize({
  version: 13,
  states: "!|QVQPOOP_OPOOOdQPO'#C_OOQO'#Cg'#CgQVQPOOPiOPO)C>`OnQQO,58yOOQO-E6e-E6ePOOO/'3z/'3zOOQO'#Cb'#CbOOQO'#Ch'#ChO!PQQO1G.eOOQO1G.e1G.eOOQO-E6f-E6fOOQO7+$P7+$P",
  stateData: "!b~OPPQ~OSQO`RO~OPTO~OTUO~O_WO~OVXOWXOXXOYXO`[O~OVXOWXOXXOYXO`^O~O",
  goto: "r]PPP^PPbPPPPflTROSTYUZQSORVSQZUR]Z",
  nodeNames: "⚠ LineComment Sequence Statement TimeTag Command Arg String Enum Integer Float",
  maxTerm: 16,
  skippedNodes: [0,1],
  repeatNodeCount: 2,
  tokenData: "+m~R]YZzrs!P|}!b}!O!y!Q!R#X!R![#o!]!^$f!c!d$q!d!t)v!t!u*[!u!})v#R#S)v#T#o)v~!PO`~~!SROr!Prs!]s~!P~!bOV~~!eP!a!b!h~!kPpq!n~!qPz{!t~!yO_~~!|P!Q![#P~#UPX~!Q![#P~#^RX~!O!P#g!Q![#o#l#m#z~#lPY~!Q![#g~#tQX~!O!P#g!Q![#o~#}R!Q![$W!c!i$W#T#Z$W~$]RX~!Q![$W!c!i$W#T#Z$W~$kQP~OY$fZ~$fR$vTWQ!O!P%V!Q![%t!c!})v#R#S)v#T#o)vP%YR!c!}%c#R#S%c#T#o%cP%hSTP!Q![%c!c!}%c#R#S%c#T#o%cR%yTWQ!O!P%V!Q![&Y!c!})v#R#S)v#T#o)vR&_TWQ!O!P%V!Q![&n!c!})v#R#S)v#T#o)vR&sTWQ!O!P%V!Q!['S!c!})v#R#S)v#T#o)vR'XUWQ}!O'k!O!P%V!Q![)v!c!})v#R#S)v#T#o)vP'nP!Q!['qP'tP!Q!['wP'zP!Q!['}P(QP!v!w(TP(WP!Q![(ZP(^P!Q![(aP(dP![!](gP(jP!Q![(mP(pP!Q![(sP(vP![!](yP(|P!Q![)PP)SP!Q![)VP)[PSP!O!P)_P)bP!Q![)eP)hP!Q![)kP)nP!Q![)qP)vOSPR){TWQ!O!P%V!Q![)v!c!})v#R#S)v#T#o)vR*aTWQ!O!P%V!Q![*p!c!})v#R#S)v#T#o)vR*uTWQ!O!P%V!Q![+U!c!})v#R#S)v#T#o)vR+ZUWQ!O!P%V!Q![)v![!](g!c!})v#R#S)v#T#o)v",
  tokenizers: [0, 1],
  topRules: {"Sequence":[0,2]},
  tokenPrec: 0
});
...
let parserWithMetadata = parser.configure({
  props: [
    styleTags({
      TimeTag: tags.controlKeyword,
      Command: tags.typeName,
      Enum: tags.propertyName,
...
const sequenceLanguage = LezerLanguage.define({
...
export { EditorState, EditorView, LanguageSupport, basicSetup, completeFromList, ifNotIn, linter, sequenceLanguage, snippetCompletion, syntaxTree };
