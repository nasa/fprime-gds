""" ccsds: implementation of framing plugin to support CCSDS
...
from fprime_encryption.framing.chain import ChainedFramerDeframer

from fprime_encryption.framing.apid import APID
...
class SpaceDataLinkFramerDeframer(SpacePacketFramerDeframer):
    """ CCSDS Framer/Deframer Implementation """
